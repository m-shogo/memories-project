#!/usr/bin/env python3
"""Pin transactional rollback for compatibility execution status reconciliation."""
...
def expect_post_write_rollback(module) -> None:
    ...
    require(isinstance(gate, dict), "OPS-P0-008 missing for rollback probe")
...
def main() -> int:
    ...
    print("PASS: compatibility execution status reconcile rolls back aggregate validation failures")
    return 0
