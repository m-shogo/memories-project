...
def load_reconciler():
    spec = importlib.util.spec_from_file_location(
        "memory_os_parser_inflight_cancellation_reconcile_negative", RECONCILER
    )
...
def main() -> int:
    ...
    print(
        "PASS: parser in-flight cancellation reconcile rejects authority substitution "
        "and rolls back post-write aggregate rejection"
    )
    return 0
