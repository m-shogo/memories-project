#!/usr/bin/env python3
"""Reject corrupt environment-generation authority before migration admission."""
...
def expect_rejected(label: str) -> None:
    ...
    if completed.returncode != 0:
        return
    raise RuntimeError(f"migration admission validator accepted corrupt generation authority: {label}")
...
def main() -> int:
    ...
    print("PASS: migration production-shaped admission rejects corrupt environment-generation authority before admission")
