#!/usr/bin/env python3
"""Fail-closed negatives for pre-fence mutation reconciliation authority."""
...
def main() -> int:
    ...
    print("PASS: pre-fence mutation reconcile authority identity and rollback are fail-closed")
    return 0
