#!/usr/bin/env python3
"""Reject corrupt environment-generation authority before distributed runtime admission."""
...
def expect_rejected(label: str) -> None:
    ...
    if completed.returncode != 0:
        return
    raise RuntimeError(f"distributed-runtime validator accepted corrupt generation authority: {label}")
...
def main() -> int:
    ...
    print("PASS: distributed rate-limit runtime rejects corrupt environment-generation authority before admission")
