#!/usr/bin/env python3
"""Fail-closed negatives for deletion worker SIGKILL reconciliation authority."""
...
def main() -> int:
    ...
    print("PASS: deletion worker SIGKILL reconcile authority and rollback are fail-closed")
    return 0
