#!/usr/bin/env python3
"""Prove typed non-resurrection authority loading fails closed on unreadable repo-local inputs."""
...
def load_validator():
    spec = importlib.util.spec_from_file_location("memory_os_typed_non_resurrection_load_negative", VALIDATOR)
...
def main() -> int:
    ...
    print("Typed unreadable-authority negative suite PASS")
    return 0
