...
def main() -> int:
    ...
    require(all(isinstance(value, int) and not isinstance(value, bool) and value >= 0 for value in (registered, semantic, unsuperseded_registered, unsuperseded_semantic, distinct_semantic, candidate_count)), "OPS-P0-007 dependency counts invalid")
