...
def validate_source_registries() -> dict[str, int]:
    ...
    pair_review_validator = load_module(PAIR_REVIEW_VALIDATOR_PATH, "memory_os_release_pair_review_validator_for_foundation")
    try:
        ...
        require(isinstance(pair_rows, list), "release pair rows invalid")
        for row in pair_rows:
            require(isinstance(row, dict), "release pair row must be an object")
