...
CANONICAL_MISSING = [
    ...
    "production rolling deployment using approved releases, including simultaneous old/current traffic, connection drain, rollout ordering, monitored stop conditions, application rollback timing and deterministic recovery",
...
def main() -> int:
    ...
    for label, terms in {
        ...
        "rolling traffic": ("production rolling", "connection drain", "application rollback"),
