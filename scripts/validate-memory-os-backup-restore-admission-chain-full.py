...
STEPS: tuple[tuple[str, str], ...] = (
    ...
    ("scripts/validate-memory-os-backup-restore-admission-chain-workflow-permissions-negative.py", "admission-chain workflow permission negative"),
    ...
    ("scripts/validate-memory-os-production-equivalent-environment-generation-authority-path-negative.py", "environment generation authority-path negative"),
    ("scripts/validate-memory-os-production-equivalent-environment-generation-append-rollback-negative.py", "environment generation append rollback negative"),
    ...
    ("scripts/validate-memory-os-production-equivalent-environment-eligibility-load-negative.py", "semantic environment eligibility unreadable/escaped authority negative"),
    ...
    ("scripts/validate-memory-os-recovery-objectives-digest-negative.py", "recovery objectives approval digest negative"),
    ("scripts/validate-memory-os-recovery-objectives-append-rollback-negative.py", "recovery objectives append rollback negative"),
    ...
    ("scripts/validate-memory-os-backup-restore-generation-evidence-load-negative.py", "generation evidence unreadable/escaped authority negative"),
    ...
    ("scripts/validate-memory-os-backup-restore-promotion-review-negative.py", "human promotion review semantic/transaction negative"),
