...
or traffic. The only reconcile step is the existing deterministic admission-chain
projection, which remains fail-closed and keeps productionDecision=NO_GO.
"""
